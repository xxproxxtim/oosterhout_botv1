...
module.exports.run = async (client, message, args) => {
    ...
    if (kickUser.permissions.has("KICK_MEMBERS")) return message.reply("Je kan geen staff kicken.");
    ...
    var embedPromt = new discord.MessageEmbed()
        ...
        .setDescription(`Wil je ${kickUser} (${kickUser.id}) kicken?`)
        .setTimestamp()
        .setFooter(`${message.author.username}`);
    var embed = new discord.MessageEmbed()
        .setColor("RED")
        .setTitle("Persoon gekickt.")
        .setDescription(`**Gekickt:** ${kickUser.user.username} (${kickUser.id})
